...
module.exports = class Client {
	...
	ebicsRequest(order) {
		return new Promise(async (resolve, reject) => {
			...
			const send = () => $request.post({
				...
				console.log("Response from Ebics: ", data);
				console.log("Raw Response from Ebics: ", res);
				console.log("Error from ebics:", err);
	...
	async setBankKeys(bankKeys) {
		...
		console.log("Keys Object while setting", keysObject);
